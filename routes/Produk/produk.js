...
router.put("/editProduk/:id", controllerProduk.upload.single('foto_produk'), controllerProduk.editProduk);
...
router.get("/produk/terlaris", controllerProduk.getProdukTerlaris);
