...
router.post('/post', protect(['super admin', 'user']), ControllerPost.upload.single('fotoKonten'), ControllerPost.PostUlasanForum);
...
router.get('/forumReport/:id', ControllerPost.getforumReport);
